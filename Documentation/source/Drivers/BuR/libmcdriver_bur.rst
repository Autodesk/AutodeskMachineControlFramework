...
.. cpp:class:: LibMCDriver_BuR::CWrapper

	All types of MC Driver BR Automation 2.0 reside in the namespace LibMCDriver_BuR and all
	functionality of MC Driver BR Automation 2.0 resides in LibMCDriver_BuR::CWrapper.

	A suitable way to use LibMCDriver_BuR::CWrapper is as a singleton.

	.. cpp:function:: void GetVersion(LibMCDriver_BuR_uint32 & nMajor, LibMCDriver_BuR_uint32 & nMinor, LibMCDriver_BuR_uint32 & nMicro)
	...
	.. cpp:function:: void InjectComponent(const std::string & sNameSpace, const LibMCDriver_BuR_pvoid pSymbolAddressMethod)
	...
	.. cpp:function:: LibMCDriver_BuR_pvoid GetSymbolLookupMethod()
...
.. cpp:type:: std::shared_ptr<CWrapper> LibMCDriver_BuR::PWrapper
