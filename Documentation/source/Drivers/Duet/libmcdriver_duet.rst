...
.. cpp:class:: LibMCDriver_Duet::CWrapper

	All types of MC Driver Duet reside in the namespace LibMCDriver_Duet and all
	functionality of MC Driver Duet resides in LibMCDriver_Duet::CWrapper.

	A suitable way to use LibMCDriver_Duet::CWrapper is as a singleton.

	.. cpp:function:: void GetVersion(LibMCDriver_Duet_uint32 & nMajor, LibMCDriver_Duet_uint32 & nMinor, LibMCDriver_Duet_uint32 & nMicro)
	...
	.. cpp:function:: void InjectComponent(const std::string & sNameSpace, const LibMCDriver_Duet_pvoid pSymbolAddressMethod)
	...
	.. cpp:function:: LibMCDriver_Duet_pvoid GetSymbolLookupMethod()
...
.. cpp:type:: std::shared_ptr<CWrapper> LibMCDriver_Duet::PWrapper
