...
.. cpp:class:: LibMCDriver_S7Net::CWrapper

	All types of MC Driver S7Net 2.0 reside in the namespace LibMCDriver_S7Net and all
	functionality of MC Driver S7Net 2.0 resides in LibMCDriver_S7Net::CWrapper.

	A suitable way to use LibMCDriver_S7Net::CWrapper is as a singleton.

	.. cpp:function:: void GetVersion(LibMCDriver_S7Net_uint32 & nMajor, LibMCDriver_S7Net_uint32 & nMinor, LibMCDriver_S7Net_uint32 & nMicro)
	...
	.. cpp:function:: void InjectComponent(const std::string & sNameSpace, const LibMCDriver_S7Net_pvoid pSymbolAddressMethod)
	...
	.. cpp:function:: LibMCDriver_S7Net_pvoid GetSymbolLookupMethod()
...
.. cpp:type:: std::shared_ptr<CWrapper> LibMCDriver_S7Net::PWrapper
