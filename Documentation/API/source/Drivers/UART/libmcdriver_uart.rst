...
.. cpp:class:: LibMCDriver_UART::CWrapper

	All types of Generic UART Driver reside in the namespace LibMCDriver_UART and all
	functionality of Generic UART Driver resides in LibMCDriver_UART::CWrapper.

	A suitable way to use LibMCDriver_UART::CWrapper is as a singleton.

	.. cpp:function:: void GetVersion(LibMCDriver_UART_uint32 & nMajor, LibMCDriver_UART_uint32 & nMinor, LibMCDriver_UART_uint32 & nMicro)
	...
	.. cpp:function:: void InjectComponent(const std::string & sNameSpace, const LibMCDriver_UART_pvoid pSymbolAddressMethod)
	...
	.. cpp:function:: LibMCDriver_UART_pvoid GetSymbolLookupMethod()
...
.. cpp:type:: std::shared_ptr<CWrapper> LibMCDriver_UART::PWrapper
