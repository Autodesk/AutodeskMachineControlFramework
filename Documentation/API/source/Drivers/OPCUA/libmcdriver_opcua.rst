...
.. cpp:class:: LibMCDriver_OPCUA::CWrapper

	All types of MC Driver OPCUA reside in the namespace LibMCDriver_OPCUA and all
	functionality of MC Driver OPCUA resides in LibMCDriver_OPCUA::CWrapper.

	A suitable way to use LibMCDriver_OPCUA::CWrapper is as a singleton.

	.. cpp:function:: void GetVersion(LibMCDriver_OPCUA_uint32 & nMajor, LibMCDriver_OPCUA_uint32 & nMinor, LibMCDriver_OPCUA_uint32 & nMicro)
	...
	.. cpp:function:: void InjectComponent(const std::string & sNameSpace, const LibMCDriver_OPCUA_pvoid pSymbolAddressMethod)
	...
	.. cpp:function:: LibMCDriver_OPCUA_pvoid GetSymbolLookupMethod()
...
.. cpp:type:: std::shared_ptr<CWrapper> LibMCDriver_OPCUA::PWrapper
