...
.. cpp:class:: LibMCDriver_ScanLab::CWrapper

	All types of MC Driver ScanLab RTC6 reside in the namespace LibMCDriver_ScanLab and all
	functionality of MC Driver ScanLab RTC6 resides in LibMCDriver_ScanLab::CWrapper.

	A suitable way to use LibMCDriver_ScanLab::CWrapper is as a singleton.

	.. cpp:function:: void GetVersion(LibMCDriver_ScanLab_uint32 & nMajor, LibMCDriver_ScanLab_uint32 & nMinor, LibMCDriver_ScanLab_uint32 & nMicro)
	...
	.. cpp:function:: void InjectComponent(const std::string & sNameSpace, const LibMCDriver_ScanLab_pvoid pSymbolAddressMethod)
	...
	.. cpp:function:: LibMCDriver_ScanLab_pvoid GetSymbolLookupMethod()
...
.. cpp:type:: std::shared_ptr<CWrapper> LibMCDriver_ScanLab::PWrapper
