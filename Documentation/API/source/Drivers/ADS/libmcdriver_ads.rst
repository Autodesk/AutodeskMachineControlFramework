...
.. cpp:class:: LibMCDriver_ADS::CWrapper

	All types of MC Driver ADS reside in the namespace LibMCDriver_ADS and all
	functionality of MC Driver ADS resides in LibMCDriver_ADS::CWrapper.

	A suitable way to use LibMCDriver_ADS::CWrapper is as a singleton.

	.. cpp:function:: void GetVersion(LibMCDriver_ADS_uint32 & nMajor, LibMCDriver_ADS_uint32 & nMinor, LibMCDriver_ADS_uint32 & nMicro)
	...
	.. cpp:function:: void InjectComponent(const std::string & sNameSpace, const LibMCDriver_ADS_pvoid pSymbolAddressMethod)
	...
	.. cpp:function:: LibMCDriver_ADS_pvoid GetSymbolLookupMethod()
...
.. cpp:type:: std::shared_ptr<CWrapper> LibMCDriver_ADS::PWrapper
