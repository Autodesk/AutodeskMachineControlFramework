...
.. cpp:class:: LibMCDriver_ASL::CWrapper

	All types of ASL Inkjet Driver Interface reside in the namespace LibMCDriver_ASL and all
	functionality of ASL Inkjet Driver Interface resides in LibMCDriver_ASL::CWrapper.

	A suitable way to use LibMCDriver_ASL::CWrapper is as a singleton.

	.. cpp:function:: void GetVersion(LibMCDriver_ASL_uint32 & nMajor, LibMCDriver_ASL_uint32 & nMinor, LibMCDriver_ASL_uint32 & nMicro)
	...
	.. cpp:function:: void InjectComponent(const std::string & sNameSpace, const LibMCDriver_ASL_pvoid pSymbolAddressMethod)
	...
	.. cpp:function:: LibMCDriver_ASL_pvoid GetSymbolLookupMethod()
...
.. cpp:type:: std::shared_ptr<CWrapper> LibMCDriver_ASL::PWrapper
