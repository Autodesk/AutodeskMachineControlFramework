...
act.exe LibMCUI.xml -bindings ..\Framework\HeadersCore -interfaces ..\Framework\InterfacesDev -suppresssubcomponents -suppresslicense -suppressstub -suppressexamples
