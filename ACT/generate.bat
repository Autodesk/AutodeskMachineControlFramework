...
act.exe LibMCDriverEnv.xml -bindings ..\Framework\HeadersDev -interfaces ..\Framework\InterfacesCore -suppresssubcomponents -suppresslicense -suppressstub -suppressexamples
